...
- `docs/design-docs/design-001-links-and-embeds.md` defines the shared parse contract and current note-embed boundaries used by this design.
- `docs/design-docs/design-002-render.md` defines the active note render semantics that this web design reuses.
