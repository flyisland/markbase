...
**Status:** Archived Patch  
**Target:** markbase CLI  
**Merged into:** `docs/design-docs/design-006-template-system.md`, `docs/design-docs/design-004-note-verify.md`, `README.md`
...
`design-007` was created as a temporary patch contract during `exec-003` to guide the transition from legacy outer-frontmatter instance semantics to the `_schema.instance` model.

That transition is now complete:

- template creation semantics live in `docs/design-docs/design-006-template-system.md`
- verifier semantics live in `docs/design-docs/design-004-note-verify.md`
...
- `design-006`: template normalization, `_schema.instance`, and `note new --template`
...
- moving instance defaults under `_schema.instance`
