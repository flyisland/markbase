...
**Status:** Implemented  
**Target:** markbase CLI  
**Related docs:** `docs/design-docs/implemented/design-004-note-verify.md`, `ARCHITECTURE.md`, `README.md`
...
It does not restate the full `note verify` command contract, output shape, or exit behavior. Those belong to `docs/design-docs/implemented/design-004-note-verify.md`.
...
`note verify` consumes template files as validation inputs, but the verify command contract is owned by `docs/design-docs/implemented/design-004-note-verify.md`.
...
This is not a confirmed wikilink. The current markbase verification contract for dangling references is defined in `docs/design-docs/implemented/design-004-note-verify.md`.
...
`docs/design-docs/implemented/design-004-note-verify.md` owns:
