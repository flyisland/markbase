...
- `docs/design-docs/implemented/design-001-links-and-embeds.md` defines the shared parsing and normalization contract that render consumes for body scanning and `.base#View` selector handling.
...
- `docs/references/legacy-designs/note_render_design.md` remains historical context only. When it differs from current implementation, this document is the active contract.
