...
**Status:** Active  
**Target:** markbase CLI  
**Related docs:** `ARCHITECTURE.md`, `README.md`, `docs/design-docs/design-005-indexing.md`, `docs/design-docs/design-001-links-and-embeds.md`
...
`note resolve` depends on the indexing contract from `docs/design-docs/design-005-indexing.md`:
