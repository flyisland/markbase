...
**状态：** 待执行  
**日期：** 2026-03-08  
**关联设计：** `docs/references/legacy-designs/description_design.md`
...
- 完成后可归档或删除
- 长期保留的信息应回到 `docs/references/legacy-designs/description_design.md`
...
- 必要时 `AGENTS.md`
- 如有需要，`docs/references/legacy-designs/template_schema.md`
...
- [ ] 视需要更新 `docs/references/legacy-designs/template_schema.md`
