...
**面向：** Coding Agent  
**参考设计：** `docs/references/legacy-designs/note_render_design.md`（必须先阅读）  
**影响文件：**
...
2. `docs/references/legacy-designs/note_render_design.md` — 所有翻译规则的权威来源
...
该模块包含所有翻译逻辑。**所有规则以 `docs/references/legacy-designs/note_render_design.md` §Filter 翻译规范为权威，遇到歧义以设计文档为准。**
