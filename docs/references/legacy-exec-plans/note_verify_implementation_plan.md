...
**面向：** Coding Agent  
**参考设计：** `docs/design-docs/implemented/design-004-note-verify.md`  
**影响文件：** `src/main.rs`、`src/verifier.rs`（新增）、`src/lib.rs`、`tests/cli_note.rs`、`tests/common.rs`、`README.md`、`AGENTS.md`

在开始前请先阅读：`AGENTS.md`、`docs/references/legacy-designs/template_schema.md`、`docs/design-docs/implemented/design-004-note-verify.md`
