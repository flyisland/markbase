...
**Target Version:** TBD  
**Spec Reference:** `docs/references/legacy-designs/properties_design.md`

---

## 1. Overview

This document outlines the implementation plan for migrating from the old "reserved field" system to explicit `file.` and `note.` namespace prefixes, as defined in `docs/references/legacy-designs/properties_design.md`.
...
| File | Changes |
|------|---------|
| `docs/references/legacy-designs/properties_design.md` | Mark as "Implemented" status |
...
#### 3.3.2 Update `docs/references/legacy-designs/properties_design.md`
...
- [ ] Update `docs/references/legacy-designs/properties_design.md` status
